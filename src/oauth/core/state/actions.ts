...
export type OAuthActionTypes = AuthorizationRequestAction |
...
export function authorizationRequest(authorizationUrl: string): OAuthActionTypes {
  return {
...
export function authorizationRequestSuccess(authorizationCode: string, state: string): OAuthActionTypes {
  return {
...
export function authorizationRequestFailure(errorCode: string, errorDescription?: string, errorId?: string): OAuthActionTypes {
  return {
...
export function tokenRequestSuccess(accessToken: string,
  expiresIn: bigint,
  tokenType: string,
  refreshToken?: string): OAuthActionTypes {
  return {
...
export function tokenRequestFailure(errorCode: string, errorUri?: string, errorDescription?: string, errorId?: string): OAuthActionTypes {
  return {
